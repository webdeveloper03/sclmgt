...
class Studentfee extends Admin_Controller {
    ...
    public function getcollectfee() {
        ...
        $where_mode['fees_mode_status'] = 1;
        $data['fees_modes'] = $this->broadsheet_model->select('fees_modes',$where_mode);
    ...
    public function printFeesByName() {
        ...
        $settings = $this->broadsheet_model->select('sch_settings');
        $data['settings'] = $settings->row();

        $fee_record = $this->studentfeemaster_model->getFeeByInvoice($invoice_id, $sub_invoice_id);
        $data['student'] = $student;
        $data['sub_invoice_id'] = $sub_invoice_id;
        $data['feeList'] = $fee_record;
        $this->load->view('print/printFeesByName1', $data);
    }
    ...
    public function printFeesByGroup() {
        ...
        $this->load->view('print/printFeesByGroup2', $data);
    ...
    {
        $this->load->view('print/printFeesByGroup1', $data);
    }

    public function print_preview_2()
    {
        $this->load->view('print/printFeesByGroup2', $data);
    }
