            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom box box-primary theme-shadow">
                    <ul class="nav nav-tabs pull-right">
                        <li ><a href="#tab_10" data-toggle="tab">Monnify</a></li>
                    ...
                    <div class="tab-content pb0">
                        ...
                        <div class="tab-pane " id="tab_10">
                            <form role="form" id="monnifyform" action="<?php echo site_url('admin/paymentsettings/monnify') ?>" class="form-horizontal" method="post">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-7">
                                                <?php $paytm_result = check_in_array('monnify', $paymentlist); ?>
                                                <div class="form-group">
                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="monnify_api_key">Api Key<small class="req"> *</small></label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input name="monnify_api_key" type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $paytm_result->monnify_api_key; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input name="monnify_contract_code" type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $paytm_result->monnify_contract_code; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="monnify_sub_account">Sub Account<small class="req"> *</small></label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input name="monnify_sub_account" type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $paytm_result->monnify_sub_account; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="monnify_fee_percentage">Fee Percentage<small class="req"> *</small></label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input name="monnify_fee_percentage" type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $paytm_result->monnify_fee_percentage; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="monnify_split_amount">Split Amount<small class="req"> *</small></label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input name="monnify_split_amount" type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $paytm_result->monnify_split_amount; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="monnify_enable_sms">Enable SMS</label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input name="monnify_enable_sms" type="checkbox" value="1" style="margin-top: 10px;" <?php if($paytm_result->monnify_enable_sms == 1){ echo "checked"; }?>>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="monnify_commission_amount">Commission Amount</label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input name="monnify_commission_amount" type="text" class="form-control col-md-7 col-xs-12" value="<?php echo $paytm_result->monnify_commission_amount; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="monnify_sms_content">SMS Content</label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <textarea name="monnify_sms_content" class="form-control col-md-7 col-xs-12"><?php echo $paytm_result->monnify_sms_content; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://monnify.com/" target="_blank"><img src="<?php echo base_url(); ?>/backend/images/monnify.png" width="200"><p>https://monnify.com/</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
                    ...
                    <form role="form" action="<?php echo site_url('admin/paymentsettings/setting') ?>" id="payment_gateway" method="POST">
                        <div class="box-body minheight199">
                            <div class="form-group"> <!-- Radio group !-->
                                ...
                                <div class="radio">
                                    <label><input type="radio"  name="payment_setting" value="monnify" <?php if ($radio_check == 'monnify') { echo "checked"; } ?>> Monnify </label>
                                </div>
...
$(document).ready(function(){
    $("#monnifyform").validate({
        rules :{
            ...
            monnify_fee_percentage : {
                required : true
            },
            monnify_split_amount : {
                required : true
            }
        },
        messages :{
            ...
            monnify_contract_code : {
                required : 'Please Enter Contract Code'
            },
            monnify_sub_account : {
                required : 'Please Enter Sub Account'
            },
            monnify_fee_percentage : {
                required : 'Please Enter Fee Percentage'
            },
            monnify_split_amount : {
                required : 'Please Enter Split Amount'
            }
        }
    });
});    
