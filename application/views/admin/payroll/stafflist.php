            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form role="form" id="schsetting_form" action="<?php echo site_url('admin/payroll/paymentSuccess') ?>">
                        <input type="hidden" name="paymentcontact" id="paymentcontact" value="">
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <select name="payment_mode" id="payment_mode"  class="form-control">
                                ...
                                {
                                ?>
                                <option value="<?php echo $payment_mode->payment_mode_id; ?>"><?php echo $payment_mode->payment_mode_name; ?></option>
                                <?php
                                }
                                ?>
    ...
    function getRecord(id, year) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('input[name="paymentcontact"]').val(result.result.contact_no);
