                        ...
                        <form  enctype="multipart/form-data" action="<?php echo site_url('admin/admitcard/edit/' . $admitcard->id) ?>"  id="editform" name="editform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="is_username" name="is_username" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_username', '1', (set_value('is_username', $admitcard->is_username) == 1) ? TRUE : FALSE); ?>>
                                        <label for="is_username" class="label-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                    <label>Password</label>
                                    <div class="material-switch switchcheck">
                                        <input id="is_password" name="is_password" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_password', '1', (set_value('is_password', $admitcard->is_password) == 1) ? TRUE : FALSE); ?>>
                                        <label for="is_password" class="label-success"></label>
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
