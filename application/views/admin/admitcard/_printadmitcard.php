                            ...
                            <tr>
                                <td valign="top">
                                    <table cellpadding="0" cellspacing="0" width="100%" >
                                        ...
                                        <tr>
                                            <?php
                                            if ($admitcard->is_username) {
                                                ?>
                                                <td valign="top" style="padding-bottom: 10px;"><?php echo 'Username'; ?></td>
                                                <td valign="top" style="text-transform: uppercase; font-weight: bold;padding-bottom: 10px;"><?php echo $student_value->username; ?></td>
                                                <?php
                                            }
                                            ?>
                                            <?php
                                            if ($admitcard->is_password) {
                                                ?>
                                                <td valign="top" style="padding-bottom: 10px;"><?php echo 'Password'; ?></td>
                                                <td valign="top" style="text-transform: uppercase; font-weight: bold;padding-bottom: 10px;"><?php echo $student_value->password; ?></td>
                                                <?php
                                            }
                                            ?>
