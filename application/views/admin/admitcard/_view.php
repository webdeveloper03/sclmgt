                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%" >
                                        ...
                                        <tr>
                                            ...
                                            if ($admitcard->is_username) {
                                                ...
                                                <td valign="top" style="text-transform: uppercase; font-weight: bold;padding-bottom: 10px;">olivier</td>
                                                <?php
                                            }
                                            ?>
                                            ...
                                            if ($admitcard->is_password) {
                                                ...
                                                <td valign="top" style="text-transform: uppercase; font-weight: bold;padding-bottom: 10px;">123456</td>
                                                <?php
                                            }
                                            ?>
