      ...
      <div class="row">
         <div class="col-md-12">
            <div class="box box-primary">
               ...
               <form id="resultfeesform" action="<?php echo site_url('admin/result_fees/edit_fees/'.$this->uri->segment(4)) ?>" method="post" accept-charset="utf-8">
                  <div class="box-body">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <select id="session" name="session" class="form-control">
                              ...
                              {
                              ?>
                                 <option value="<?php echo $session->id; ?>" <?php if($session->id == $fees->result_fees_session){ echo "selected"; }  ?>><?php echo $session->session; ?></option>
                              <?php                                       
                              }
                              ?>
                           </select>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <select id="class_id" name="class_id" class="form-control" onchange="select_section()">
                              ...
                              {
                              ?>
                              <option value="<?php echo $class->id; ?>" <?php if($class->id == $fees->result_fees_class){ echo "selected"; }  ?>><?php echo $class->class; ?></option>
                              <?php                                       
                              }
                              ?>
                           </select>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <select  id="section_id" name="section_id" class="form-control" >                                       
                              ...
                              {
                              ?>
                              <option value="<?php echo $section->id; ?>" <?php if($section->id == $fees->result_fees_term){ echo "selected"; }  ?>><?php echo $section->section; ?></option>
                              <?php   
                              }
                              ?>
                           </select>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" id="fees" name="fees" class="form-control" value="<?php echo $fees->result_fees_amount; ?>">                           
                        </div>
                     </div>
                  </div>
