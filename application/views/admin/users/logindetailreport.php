                                    ...
                                    if (empty($resultlist)) {
                                        ...
                                        foreach ($resultlist as $student) {
                                            ...
                                            ?>>
                                                ...
                                                <td style="float: right;"><a href="javascript:void(0)" onclick="edit_credentials(<?php echo $student['id']; ?>)"><i class="fa fa-edit"></i></a></td>
                                            </tr>
                                            <?php
                                            $i++;
                                            $count++;
...
function edit_credentials(stud_id)
{
    $.ajax({
        url: "<?php echo site_url('admin/users/edit_credentials'); ?>",
        type: "POST",
