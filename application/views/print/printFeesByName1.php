                        ...
                        <hr style="margin-top: 5px;margin-bottom: 5px;" />
                            ...
                            <div class="row print_group">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-6"><span class="print_value"><?php $amount = number_format($record->amount, 2, '.', ''); echo $currency_symbol . $amount; ?></span></div>    
                                </div>                            
                            </div>
                            <div class="row print_group">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="row print_group">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-6"><span class="print_value"><?php 
                            ...
                            <div class="row print_group">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-md-6 col-sm-6 col-xs-6"><strong><span class="print_label">Date of Payment</span></strong></div>
                                    <div class="col-md-6 col-sm-6 col-xs-6"><span class="print_value"><?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($record->date)); ?></span></div>    
                                </div>                            
                            </div>
                            <div class="row print_group">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-md-6 col-sm-6 col-xs-6"><strong><span class="print_label">Mode of Payment</span></strong></div>
                                    <div class="col-md-6 col-sm-6 col-xs-6"><span class="print_value"><?php echo $record->payment_mode; ?></span></div>    
                                </div>                            
                            </div>
                            <div class="row print_group">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-md-6 col-sm-6 col-xs-6"><strong><span class="print_label">Payment id</span></strong></div>
                                    <div class="col-md-6 col-sm-6 col-xs-6"><span class="print_value"><?php echo $feeList->id . "/" . $sub_invoice_id; ?></span></div>    
                                </div>                            
                            </div>
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
