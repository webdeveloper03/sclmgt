...
<html <?php echo $this->customlib->getRTL(); ?>>
    <head>
        ...
        <script src="<?php echo base_url(); ?>backend/js/jquery.validate.min.js"></script>
        <!-- fullCalendar -->
...
<?php } } ?>
                        ...
                        <li class="treeview <?php echo set_Topmenu('Examinations'); ?>">
                                ...
                                <ul class="treeview-menu">
                                    <li class="<?php echo set_Submenu('result/index'); ?>"><a href="<?php echo base_url(); ?>user/result"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('exam_result_card'); ?></a></li>
