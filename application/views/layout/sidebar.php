        ...
        <ul class="sidebar-menu verttop">
            ...
            if ($this->module_lib->hasActive('examination')) {
                if (($this->rbac->hasPrivilege('exam_group', 'can_view') ||
                        ...
                        $this->rbac->hasPrivilege('subject_grade', 'can_view') ||
                        $this->rbac->hasPrivilege('result_grade', 'can_view') ||
                        $this->rbac->hasPrivilege('result_fees', 'can_view')
                        )) {
                    ?>
                    <li class="treeview <?php echo set_Topmenu('Examinations'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            {
                            ?>
                                <li <?php if(isset($set) && $set == 'subject_grade'){ ?>class="active"<?php } ?>>
                                    <a href="<?php echo site_url('admin/subject_grade'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('subject_grade'); ?></a>
                                </li>
                            <?php 
                            } 
                            ?>    
                            ...
                            {
                            ?>
                                <li <?php if(isset($set) && $set == 'result_grade'){ ?>class="active"<?php } ?>>
                                    <a href="<?php echo site_url('admin/result_grade'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('result_grade'); ?></a>
                                </li>
                            <?php 
                            } 
                            ...
                            {
                            ?>
                                <li <?php if(isset($set) && $set == 'result_fees'){ ?>class="active"<?php } ?>>
                                    <a href="<?php echo site_url('admin/result_fees'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('next_term_fees'); ?></a>
                                </li>
                            <?php 
                            } 
                            ?>                                    
                            <?php 
                            if ($this->rbac->hasPrivilege('section_performance', 'can_view')) 
                            {
                            ?>
                                <li <?php if(isset($set) && $set == 'section_performance'){ ?>class="active"<?php } ?>><a href="<?php echo base_url(); ?>admin/section_performance"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('section_performance'); ?></a></li> 
                            <?php 
                            } 
                            ?>
                            ...
                            if ($this->rbac->hasPrivilege('broadsheet', 'can_view')) {
                                ?>
                                <li <?php if(isset($set) && $set == 'broadsheet'){ ?>class="active"<?php } ?>><a href="<?php echo base_url(); ?>admin/broadsheet"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('broadsheet'); ?></a></li> <?php } ?>    
...
if ($this->module_lib->hasActive('alumni')) {
    if (($this->rbac->hasPrivilege('manage_alumni', 'can_view')) || ($this->rbac->hasPrivilege('events', 'can_view'))) {
        ...
        ?>
            ...
            if($this->module_lib->hasActive('sms')) 
            {
                if(($this->rbac->hasPrivilege('balance', 'can_view') || $this->rbac->hasPrivilege('login', 'can_view') || $this->rbac->hasPrivilege('buy_sms', 'can_view'))) 
                {
                ?>
                <li class="treeview <?php echo set_Topmenu('sms'); ?>">
                        <a href="#">
                            <i class="fa fa-comment"></i> <span><?php echo 'SMS'; ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <?php
                            if($this->rbac->hasPrivilege('balance', 'can_view')) 
                            {
                                ?>
                                <li class="<?php echo set_Submenu('smsconfig/balance'); ?>">
                                    <a href="<?php echo site_url('smsconfig/balance'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo 'Balance'; ?></a>
                                </li>
                                <?php
                            }

                            if($this->rbac->hasPrivilege('login', 'can_view')) 
                            {
                                ?>
                                <li class="<?php echo set_Submenu('sessions/index'); ?>">
                                    <a href="http://sms.myposapp.com" target="_blank"><i class="fa fa-angle-double-right"></i> <?php echo 'Login'; ?></a>
                                </li>
                                <?php
                            }

                            if($this->rbac->hasPrivilege('buy_sms', 'can_view')) 
                            {
                                ?>
                                <li class="<?php echo set_Submenu('notification/setting'); ?>">
                                    <a href="https://dashboard.app3star.com/store/MQ==/product/bulk-sms-unit-4" target="_blank"><i class="fa fa-angle-double-right"></i> <?php echo 'Buy SMS'; ?></a>
                                </li>
                                <?php
                            }
                            ?>
            ...
            if ($this->module_lib->hasActive('system_settings')) {
                if (($this->rbac->hasPrivilege('general_setting', 'can_edit') ||
                        $this->rbac->hasPrivilege('financialdetails', 'can_view') ||
                        ...
                        $this->rbac->hasPrivilege('payment_modes', 'can_view') ||
                        $this->rbac->hasPrivilege('payment_sms', 'can_view') ||
                    ...
                    <li class="treeview <?php echo set_Topmenu('System Settings'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('financialdetails', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('financialdetails/index'); ?>"><a href="<?php echo base_url(); ?>financialdetails"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('financial_details'); ?></a></li>
                                <?php
                            }
                            ...
                            if ($this->rbac->hasPrivilege('payment_modes', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('admin/paymentsettings/payment_modes'); ?>"><a href="<?php echo base_url(); ?>admin/paymentsettings/payment_modes"><i class="fa fa-angle-double-right"></i> Payment Modes</a></li>
                                <?php
                            }

                            if ($this->rbac->hasPrivilege('fees_modes', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('admin/paymentsettings/fees_modes'); ?>"><a href="<?php echo base_url(); ?>admin/paymentsettings/fees_modes"><i class="fa fa-angle-double-right"></i> Fees Modes</a></li>
                                <?php
                            }

                            if ($this->rbac->hasPrivilege('payment_sms', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('admin/paymentsettings/payment_sms'); ?>"><a href="<?php echo base_url(); ?>admin/paymentsettings/payment_sms"><i class="fa fa-angle-double-right"></i> Salary SMS</a></li>
                                <?php
                            }

                            if ($this->rbac->hasPrivilege('fees_sms', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('feessms/index'); ?>"><a href="<?php echo base_url(); ?>feessms"><i class="fa fa-angle-double-right"></i> Fees SMS</a></li>
                                <?php
                            }
